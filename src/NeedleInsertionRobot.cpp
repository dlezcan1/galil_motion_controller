#include "NeedleInsertionRobot.hpp"

NeedleInsertionRobot::NeedleInsertionRobot(const std::string& ip_address) : NeedleInsertionRobot(ip_address, RobotArray<size_t>{1, 2, 3, 4})
{
