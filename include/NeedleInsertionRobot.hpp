...
private: // static default values
    // ORGANIZED AS: X, Y, Z, LINEAR STAGE (indices below)
    static const size_t s_gidx_X  = 0,
                        s_gidx_Y  = 1,
                        s_gidx_Z  = 2,
                        s_gidx_LS = 3;
    ...
    /* PID defaults*/
    static const RobotArray<long> s_default_kP; // = { 54,  15,  54,  25};
    static const RobotArray<long> s_default_kI; // = {  4,   4,   4,   4};
    static const RobotArray<long> s_default_kD; // = {480, 332, 480, 480};
...
const RobotArray<long> NeedleInsertionRobot::s_default_kP = { 54,  15,  54,  25};
const RobotArray<long> NeedleInsertionRobot::s_default_kI = {  4,   4,   4,   4};
const RobotArray<long> NeedleInsertionRobot::s_default_kD = {480, 332, 480, 480};